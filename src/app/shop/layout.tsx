      ...
      <div className="container max-w-7xl mx-auto flex h-20 items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/shop" className="group flex items-center gap-2">
             <div className="w-8 h-8 bg-zinc-900 text-white rounded-lg flex items-center justify-center font-bold text-xl group-hover:scale-105 transition-transform duration-300">N</div>
             <span className="text-2xl font-bold tracking-tight text-zinc-900">
              نوبيان <span className="text-zinc-400 font-serif italic text-lg ml-1 group-hover:text-amber-600 transition-colors">شوب</span>
             </span>
          </Link>
