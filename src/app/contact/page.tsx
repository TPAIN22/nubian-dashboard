      ...
      <main className="relative z-10 px-6 md:px-12 max-w-4xl mx-auto py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-slate-800 border-b pb-2 mb-6">
          ...
          <div className="space-y-4 text-right">
            <div>
              <h3 className="font-semibold text-slate-800 mb-2">
                كيف يمكنني متابعة طلبي؟ | How can I track my order?
              </h3>
              <p className="text-slate-700">
            ...
            <div>
              <h3 className="font-semibold text-slate-800 mb-2">
                ما هي مدة الشحن؟ | What is the shipping duration?
              </h3>
              <p className="text-slate-700">
