...
import { Breadcrumbs } from '@/components/admin/page'
...
/* ============================================================================
   ...
   live in the PageHeader below, not here — duplicating them is what forces a
   shell to 64px + another 80px of page chrome.
   ========================================================================== */

export function Topbar({ nav, onOpenMobileNav }: { nav: ConsoleNav; onOpenMobileNav: () => void }) {
  const crumbs = useBreadcrumbTrail(nav)
  ...
  return (
    <header className="flex h-(--topbar-h) shrink-0 items-center gap-2 border-b border-border bg-background px-3">
      ...
      <div className="flex shrink-0 items-center gap-1">
        <SearchTrigger />
        {nav.notificationsHref && <NotificationsButton href={nav.notificationsHref} />}
        <ThemeToggle />
