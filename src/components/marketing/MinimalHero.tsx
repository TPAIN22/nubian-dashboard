    ...
    <section className="relative pt-20 pb-24 md:pt-32 md:pb-40 overflow-hidden">
      <div className="container max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16 md:mb-24">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-100 text-zinc-600 text-xs font-medium mb-8 border border-zinc-200">
            <span className="w-1.5 h-1.5 rounded-full bg-zinc-950 animate-pulse" />
            تمكين التجارة في السودان
          </div>
