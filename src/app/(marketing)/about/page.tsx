      ...
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="p-8 rounded-lg shadow-lg space-y-6 text-right">
          ...
          <div className="space-y-4 pt-6">
            <h2 className="text-2xl font-bold text-foreground border-b pb-2">رؤيتنا | Our Vision</h2>
            <p className="text-foreground leading-relaxed">
          ...
          <div className="space-y-4 pt-6">
            <h2 className="text-2xl font-bold text-foreground border-b pb-2">مهمتنا | Our Mission</h2>
            <ul className="list-disc list-inside text-foreground space-y-2 pr-4">
            ...
            <ul className="list-disc list-inside text-foreground space-y-2 pr-4 mt-4">
          ...
          <div className="space-y-4 pt-6">
            <h2 className="text-2xl font-bold text-foreground border-b pb-2">لماذا نوبيان؟ | Why Nubian?</h2>
            <ul className="list-disc list-inside text-foreground space-y-2 pr-4">
