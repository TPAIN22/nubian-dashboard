    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-6">
          يرجى إعلامنا بنوع تسجيلك القانوني للتحقق من هويتك.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          <Label className="font-semibold block mb-3">
            أسجل كـ: <span className="text-red-500">*</span>
          </Label>
        ...
        <div>
          <Label htmlFor="nationalId" className="font-semibold">
            الرقم الوطني / رقم الجواز <span className="text-red-500">*</span>
          </Label>
          <Input
            id="nationalId"
        ...
        {merchantType === 'business' && (
          <div className="animate-in slide-in-from-top-2 fade-in">
            <Label htmlFor="crNumber" className="font-semibold">
...
function CheckCircleIcon({ active }: { active: boolean }) {
  return (
    <svg
      className={`h-5 w-5 ${active ? 'text-primary' : 'text-transparent'}`}
      viewBox="0 0 20 20"
      fill="currentColor"
    >
      <path
