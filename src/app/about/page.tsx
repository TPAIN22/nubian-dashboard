        ...
        <div className="bg-white p-8 rounded-lg shadow-lg space-y-6 text-right">
          <div className="space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              والتجار المعتمدين. نحن ملتزمون بجلب أحدث المنتجات في مجالات الأزياء، الإلكترونيات، ديكور المنزل، 
              ومجموعة واسعة من السلع الأخرى.
            </p>
            <p className="text-slate-700 leading-relaxed">
          ...
          <div className="space-y-4 pt-6">
            ...
            <p className="text-slate-700 leading-relaxed">
              أن نكون المنصة الرائدة للتسوق الإلكتروني في السودان، ونوفر لعملائنا تجربة تسوق سهلة وآمنة ومريحة 
              مع ضمان جودة المنتجات وأصالتها.
            </p>
            <p className="text-slate-700 leading-relaxed">
              To be the leading e-commerce platform in Sudan, providing our customers with an easy, secure, 
              and convenient shopping experience while ensuring product quality and authenticity.
            </p>
          </div>
